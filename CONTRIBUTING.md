...
Thank you for your interest in **0xWall**.

This project is **proprietary software** and is strictly maintained by the copyright holder (**Onur Dumlu**).

### Please Note:
* **We do NOT accept Pull Requests (PRs).** Any PRs opened will be closed immediately without review.
...
**0xWall** projesi özel mülkiyettir.
